...
i4 = Ingredient(
    name='green beans', quantity=8, unit='oz', recipe_id=1)
i5 = Ingredient(
...
i9 = Ingredient(
    name='milk chocolate', quantity=12, unit='oz', recipe_id=3)
i10 = Ingredient(
    name='baking soda', quantity=1, unit='tsp', recipe_id=3)
i11 = Ingredient(
    name='milk', quantity=0.66, unit='cup', recipe_id=2)
i12 = Ingredient(
    name='bread', quantity=3, unit='slice', recipe_id=2)
i13 = Ingredient(
...
def seed_ingredients():
    ...
    db.session.add_all([
        ...
        Ingredient(name='sliced jalapenos', quantity=0.25, unit='cup', recipe_id=7),
        Ingredient(name='sour cream', quantity=0.25, unit='cup', recipe_id=7),
        Ingredient(name='sliced black olives', quantity=0.25, unit='cup', recipe_id=7),
    ])
    ...
    db.session.add_all([
        ...
        Ingredient(name='breadcrumbs', quantity=0.5, unit='cup', recipe_id=9),
        Ingredient(name='grated Parmesan cheese', quantity=0.5, unit='cup', recipe_id=9),
        ...
        Ingredient(name='salt', quantity=0.5, unit='tsp', recipe_id=9),
        Ingredient(name='black pepper', quantity=0.25, unit='tsp', recipe_id=9),
